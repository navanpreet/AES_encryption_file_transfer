...
namespace EncryptFile
{
	public class frmEncryption : System.Windows.Forms.Form
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
            ...
            this.Text = "Encrypt / Decrypt File";
		...
		private byte[] CreateKey(string strPassword)
		{
			...
			{
				bytDataToHash[i] = (byte) (Strings.Asc(chrData[i]));
			}
		...
		private void EncryptOrDecryptFile(string strInputFile, string strOutputFile, byte[] bytKey, byte[] bytIV, CryptoAction Direction)
		{
			try //In case of errors.
			{
				...
				while (lngBytesProcessed < lngFileLength)
				{
					...
					//Update Progress Bar
					pbStatus.Value = System.Convert.ToInt32((lngBytesProcessed / lngFileLength) * 100);
				}
				...
				string Wrap = System.Convert.ToString('\r' + '\n');
				if (Direction == CryptoAction.ActionEncrypt)
				{
					MessageBox.Show("Encryption Complete" + Wrap + Wrap + "Total bytes processed = " + lngBytesProcessed.ToString());
				...
				{
					//Update the user when the file is done.
					MessageBox.Show("Decryption Complete" + Wrap + Wrap + "Total bytes processed = " + lngBytesProcessed.ToString());
			...
			{
				MessageBox.Show("Please check to make sure the path and filename" + "are correct and if the file exists.");
			...
			//			{
				...
				//				{
					...
					//					txtConPassDecrypt.Text = "";
					//
					//					Interaction.MsgBox("Please check to make sure that you entered the correct" + "password.", MsgBoxStyle.Exclamation, "Invalid Password");
					//				}
					//				else
					//				{
						...
						//					txtConPassEncrypt.Text = "";
						//
						//					Interaction.MsgBox("This file cannot be encrypted.", MsgBoxStyle.Exclamation, "Invalid File");
						//
						//				}
						//
						//			}
					...
					private void btnBrowseEncrypt_Click(System.Object sender, System.EventArgs e)
					{
					...
					private void btnBrowseDecrypt_Click(System.Object sender, System.EventArgs e)
					{
						//Setup the open dialog.
						OpenFileDialog.FileName = "";
					...
					private void btnChangeEncrypt_Click(System.Object sender, System.EventArgs e)
					{
					...
					private void btnChangeDecrypt_Click(System.Object sender, System.EventArgs e)
					{
						//Setup up folder browser.
